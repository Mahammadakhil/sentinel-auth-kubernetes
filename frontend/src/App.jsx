...
const API_BASE = "";
//const API_BASE = "http://127.0.0.1:49284"
//const API_BASE = "http://192.168.49.2:30081";
//const API_BASE = "http://secure-auth-backend:8081";
...
function RegisterForm() {
  ...
  try {
    ...
    if (err.response?.status === 400) {
      ...
      toast.error('Network Error: Backend not reachable', { icon: '📡' });
    } else {
  ...
  //     //await api.post('http://secure-auth-backend:8081/register',{username, password});
